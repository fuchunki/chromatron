...
Block.prototype.localDraw = function() {
		let topLeftX = this.x*CELLSIZE;
		let topLeftY = this.y*CELLSIZE;
...
Conduit.prototype.localDraw = function() {
...
BeamGenerator.prototype.localDraw = function() {
		let centreX = (this.x+0.5)*CELLSIZE;
		let centreY = (this.y+0.5)*CELLSIZE;
...
Target.prototype.localDraw = function() {
		let centreX = (this.x+0.5)*CELLSIZE;
		let centreY = (this.y+0.5)*CELLSIZE;
...
Tool.prototype.draw = function(centreX,centreY) {};
Tool.prototype.localDraw = function(){this.draw((this.x+0.5)*CELLSIZE,(this.y+0.5)*CELLSIZE);};
...
Mirror.prototype.draw = function(centreX,centreY) {
...
Mirror.prototype.resultRay = function(x, y, ori ,colour,steps){
		let orientDifference = this.orientation-ori;
		if(orientDifference<0)orientDifference+=8;
		if(orientDifference==1){
			rayTraceOut(x, y, (ori+2)%8,colour,steps);
		}
		else if(orientDifference==7){
			rayTraceOut(x, y, (ori+6)%8,colour,steps);
		}
		else if(orientDifference==0)
			rayTraceOut(x, y, ori,colour,steps);
	}; 
...
Splitter.prototype.draw = function(centreX,centreY) {
...
Splitter.prototype.resultRay = function(x, y, ori,colour,steps){
		...
		if(orientDifference==1||orientDifference==5){
			rayTraceOut(x, y, (ori+2)%8,colour,steps);
		}	
		else if(orientDifference==3||orientDifference==7){
			rayTraceOut(x, y, (ori+6)%8,colour,steps);
		}
		rayTraceOut(x, y, (ori+4)%8,colour,steps);
	};
...
Bender.prototype.draw = function(centreX,centreY) {
...
Bender.prototype.resultRay = function(x, y, ori ,colour,steps){
		let orientDifference = this.orientation-ori;
		if(orientDifference<0)orientDifference+=8;
		if(orientDifference==0)
			rayTraceOut(x, y, (ori+1)%8,colour,steps);	
		else if(orientDifference==1)
			rayTraceOut(x, y, (ori+3)%8,colour,steps);
		else if(orientDifference==6)
			rayTraceOut(x, y, (ori+5)%8,colour,steps);
		else if(orientDifference==7)
			rayTraceOut(x, y, (ori+7)%8,colour,steps);
	}; 
